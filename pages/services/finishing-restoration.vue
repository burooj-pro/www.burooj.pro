    ...
    <section id="service_page" class="bg-light py-3 py-md-5">
        <div class="container py-3 py-md-5">
            <header class="gray-border-left mb-3 mb-md-5">
                <h1>Finishing and restoration</h1>
            </header>
...
export default {
    head() {
      return {
          title: 'Finishing and Restoration',
          meta: [
              {
                  hid: 'description',
                  name: 'description',
                  content:'Burooj team works on renovation and finishing of buildings, including floors and walls, plumbing, electrical, and air conditioning'
              }
