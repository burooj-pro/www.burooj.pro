<template>
  <!-- Footer -->
    <footer class="">
        <div class="container py-2 pt-md-5">
            <div class="row py-2 py-md-2">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <ul class="list-inline d-flex flex-column gap-3 gx-3 m-0 d-md-block text-center">
                        <li class="list-inline-item m-0 mx-md-3"><a class="text-decoration-none" target="_blank" href="https://twitter.com/buroojsa"><i class="bi bi-twitter"></i></a></li>
                        <li class="list-inline-item m-0 mx-md-3"><a class="text-decoration-none" target="_blank" href="https://www.instagram.com/buroojsa/"><i class="bi bi-instagram"></i></a></li>
                        <li class="list-inline-item m-0 mx-md-3"><a class="text-decoration-none" target="_blank" href="https://www.linkedin.com/company/burooj-building-services"><i class="bi bi-linkedin"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
