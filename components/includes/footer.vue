            ...
            <div class="row py-2 py-md-5">
                <div class="col-12 d-flex justify-content-center">
                    <ul class="list-inline d-flex flex-column gap-3 gx-3 m-0 d-md-block text-center">
                        ...
                        <li class="list-inline-item order-1 order-md-3 m-0"><a class="text-decoration-none" href="body"><img src="~/assets/images/logo/white.png" height="100" id="logo" class="" alt="Buruge"></a></li>
